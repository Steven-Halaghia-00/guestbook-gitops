...
│   ├── 🌐 Domain: guestbook-sha.duckdns.org
│   ├── 🔄 Auto-renewal: Yes
...
```
1. 🌐 User visits https://guestbook-sha.duckdns.org/
...
- DNS record pointing `guestbook-sha.duckdns.org` to your cluster
...
2. **Update Repository Name in kustomization.yaml**:
   ...
   # Change: ghcr.io/steven-halaghia-00/guestbook-gitops
   ```
